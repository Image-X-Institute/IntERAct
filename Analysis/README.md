...
- Copy the input traces file path to 'file_input' and the output traces path to 'file_output'.
- 'ratio' is the ratio of output trajectory to input trajectory as in the trace analysis may not run the whole trace. If you run the whole trace then it should be 1 as default.
- 'offset' is to adjust time deviation of input and output traces.
- After setting these variables you can run the code.
